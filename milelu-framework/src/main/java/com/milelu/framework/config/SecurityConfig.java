...
import com.milelu.framework.security.filter.JwtAuthenticationTokenFilter;
import com.milelu.framework.security.handle.AuthenticationEntryPointImpl;
import com.milelu.framework.security.handle.LogoutSuccessHandlerImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception
    {
        httpSecurity
                ...
                .antMatchers("/file/template/test").anonymous()
                .antMatchers("/stomp/**").anonymous()
                ...
                .antMatchers("/evaluate/result/outer/**").anonymous()
...
//                .antMatchers("/upload/uploadFile").anonymous()
                // 除上面外的所有请求全部需要鉴权认证
